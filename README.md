...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-script-editor-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15427&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-script-editor-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-script-editor` can be installed with:

```
conda install napari-script-editor
```

It is possible to list all of the versions of `napari-script-editor` available on your platform with:
